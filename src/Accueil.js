...
const Accueil = () => {
    return <div style={{display: 'flex', justifyContent: 'center'}}>
        <div style={{width: '1024px', minWidth: '320px', display: 'flex', justifyContent: 'center', flexWrap: 'wrap'}}>
            <div style={{width: '512px', minWidth: '320px', padding: '10px', display: 'flex', alignItems: 'center'}}>
            ...
            <div style={{width: '512px', minWidth: '320px', padding: '10px'}}>
                ...
                <p>L’entretien aux grandes écoles est sans doute l’épreuve la plus maitrisable, et pourtant souvent la
                    moins préparée par les candidats.</p>

                <p>A travers une préparation alliant théorie et pratique, exercices et simulation, vous transformerez
                ...
                <p>Etre soi-même lors d’un entretien est essentiel, mais ne suffit pas. L’entretien de personnalité et
